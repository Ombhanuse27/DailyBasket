...
public class MY_Order extends AppCompatActivity {
    ...
    private void fetchOrders() {
        ...
        db.collection("Orders")
                .whereEqualTo("userId", currentUserId) // Fetch orders for the logged-in user
                .get()
                        ...
                        if (items != null) {
                            for (Map<String, Object> item : items) {
                                try {
                                    ...
                                    String orderStatus = documentSnapshot.get("status") != null ? documentSnapshot.get("status").toString() : "Unknown";
